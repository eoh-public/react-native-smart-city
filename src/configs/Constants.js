...
export const TESTID = {
  ...
  OPTIONS_DROPDOWN_ACTION_DISPLAY_SELECTED:
    'OPTIONS_DROPDOWN_ACTION_DISPLAY_SELECTED',
  OPTIONS_DROPDOWN_ACTION_DONE: 'OPTIONS_DROPDOWN_ACTION_DONE',

  //NumberUpDownActionTemplate
  NUMBER_UP_DOWN_ACTION_TEXT: 'NUMBER_UP_DOWN_ACTION_TEXT',
  NUMBER_UP_DOWN_ACTION_DOWN: 'NUMBER_UP_DOWN_ACTION_DOWN',
  NUMBER_UP_DOWN_ACTION_UP: 'NUMBER_UP_DOWN_ACTION_UP',
